				...
				<tr>
					...
					<td height="70" colspan="2" align="center" bgcolor="f4f4f4" class="lp_5 t_6"><span class="lp_10">
						<select id="address" style="width:405px">
							...
							<option value="${dto.zipcode} ${dto.sido} ${dto.gugun} ${dto.dong} ${dto.ri} ${dto.bldg} ${dto.bunji}">${dto.zipcode} ${dto.sido} ${dto.gugun} ${dto.dong} ${dto.ri} ${dto.bldg} ${dto.bunji}</option>
