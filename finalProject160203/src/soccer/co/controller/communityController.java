...
public class communityController {
	...
	public String bbslist(BBSParam param, HttpServletRequest request, Model model) throws Exception {
	...
	public String bbswriteAf(foot_community_DTO bbs, Model model, String topic, String user_email, String title,
	...
	public String commentAf(int parent_no, foot_comment_DTO comdto, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String bbslike(int bbs_no, String user_email, foot_like_DTO flike, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String bbslikedel(int bbs_no, String user_email, foot_like_DTO flike, Model model,
	...
	public String bbsupdateAf(foot_community_DTO bbs, Model model, HttpServletRequest request) throws Exception {
	...
	public String bbsdetail(BBSParam param, foot_community_DTO bbs, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String commentdel(foot_comment_DTO comdto, foot_community_DTO bbs, Model model, HttpServletRequest request)
			throws Exception {
	...
	// foot_community_DTO bbs,Model model,String topic, String user_email,
	...
	public String gallerylist(BBSParam param, Model model, HttpServletRequest request) throws Exception {
	...
	public String gallerywrite(Model model, HttpServletRequest request) {
	...
	public String gallerywriteAf(@RequestParam("file") MultipartFile file, foot_community_DTO bbs, Model model,
			String user_email, String title, String content, HttpServletRequest request) throws Exception {
	...
	public String galcommentAf(int parent_no, foot_comment_DTO comdto, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String gallike(int gallery_no, String user_email, foot_like_DTO flike, Model model,
			HttpServletRequest request) throws Exception {
	...
	public String gallikedel(int gallery_no, String user_email, foot_like_DTO flike, Model model,
			HttpServletRequest request) throws Exception {
	...
	public String sellbuylist(BBSParam param, Model model, HttpServletRequest request) throws Exception {
	...
	public String sellbuywrite(Model model, HttpServletRequest request) {
	...
	public String sellbuywriteAf(foot_community_DTO bbs, Model model, String topic, String user_email, String title,
			String content, HttpServletRequest request) throws Exception {
	...
	public String sellbuycommentAf(int parent_sellbuy_no, foot_comment_DTO comdto, Model model,
			HttpServletRequest request) throws Exception {
	...
	public String sellbuylike(int sellbuy_no, String user_email, foot_like_DTO flike, Model model,
			HttpServletRequest request) throws Exception {
	...
	public String sellbuylikedel(int sellbuy_no, String user_email, foot_like_DTO flike, Model model,
			HttpServletRequest request) throws Exception {
	...
	public String sellbuydetail(BBSParam param, foot_community_DTO bbs, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String sellbuycommentdel(foot_comment_DTO comdto, foot_community_DTO bbs, Model model,
			HttpServletRequest request) throws Exception {
	...
	public String sellbuycommentupdate(foot_comment_DTO comdto, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String sellbuycommentupdateAf(foot_comment_DTO comdto, Model model, HttpServletRequest request)
			throws Exception {
	...
	public String bbsreply(foot_community_DTO bbs, Model model, HttpServletRequest request) throws Exception {
