...
.Join_Btn, .Cancel_Btn {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0.05, #4f4f4f
		), color-stop(1, #5e5e5e));
...
.Join_Btn:hover, .Cancel_Btn:hover {
	...
	background: -webkit-gradient(linear, left top, left bottom, color-stop(0.05, #5e5e5e
		), color-stop(1, #4f4f4f));
...
$(document).ready(function() {
	...
	<div class="center" align="center">
		<p class="wow1">
			<img src="image/join.png"><b> SOCCER ONE 회원가입</b>
		</p>
			...
			<table class="list_table">
				<tr>
					...
					<td colspan="5" style="text-align: left"><input type="text"
						id="text1" name="user_email1" maxlength="30">@ <select
						onchange="selectval1(this.value)">
					...
					</select> <input type="text" id="text3" name="user_email2"> <input
						type="button" name="btnPnumber" value="메일인증요청" id="btnPnumber"
						style="cursor: pointer;" /> <input type="text" name="eresult"
						id="eresult" size="" value="" style="width: 100px;" /> <input
						type="button" name="btnresult" value="확인" id="btnresult"
				...
				<tr>
					...
					<td colspan="5" style="text-align: left"><input
						type="password" name="user_pw" maxlength="8"></td>
				</tr>
				<tr>
					<th>비밀번호 확인</th>
					<td colspan="5" style="text-align: left"><input
						type="password" name="user_pw1" maxlength="8"></td>
				...
				<tr>
					<th>생년월일</th>
					<td colspan="5" style="text-align: left"><input type="text"
						name="user_birth1" maxlength="4" size="4"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;">년

						<input type="text" name="user_birth2" maxlength="2" size="2"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;">월

						<input type="text" name="user_birth3" maxlength="2" size="2"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;">일
						<input type="hidden" name="user_birth"></td>

				</tr>
				<tr>
					<th>나 이</th>
					<td colspan="5" style="text-align: left"><input type="text"
						id="user_age" name="user_age" size="2"
				...
				<tr>
					...
					</select> - <input type="text" name="user_phone1" size="4" maxlength="4"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;">-
						<input type="text" name="user_phone2" size="4" maxlength="4"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;">
						<input type="hidden" name="user_phone"></td>
				</tr>
				<tr>
					<th>신 장</th>
					<td colspan="5" style="text-align: left"><input type="text"
						id="user_high" name="user_high"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;"
						size="8px;">cm</td>
				</tr>
				<tr>
					<th>체 중</th>
					<td colspan="5" style="text-align: left"><input type="text"
						id="user_weight" name="user_weight"
						onkeyPress="if ((event.keyCode<48) || (event.keyCode>57)) event.returnValue=false;"
						size="8px;">kg</td>
				</tr>
				<tr>
					<th>주 발</th>
					<td colspan="5" style="text-align: left"><select
						id="user_foot1" name="user_foot1">
							<option value="">선택하세요</option>
							<option value="0">왼발</option>
							<option value="1">오른발</option>
							<option value="2">양발</option>
					</select> <input type="hidden" name="user_foot"></td>
				</tr>

				<tr>
					<td colspan="6" style="text-align: left"><img alt=""
						src="image/join1.png" width="5%">주포지션 <select
						name="user_position11">
							<option value=""></option>
					...
					</select> <input type="hidden" name="user_position1"> <img alt=""
						src="image/join1.png" width="5%">서브포지션1 <select
						name="user_position12">
							<option value=""></option>
							<option value="GK">GK(골키퍼)</option>
							<option value="RB">RB(오른쪽 수비수)</option>
							<option value="LB">LB(왼쪽 수비수)</option>
							...
							<option value="LWF">LWF(왼쪽 공격수)</option>
							<option value="RWF">RWF(오른쪽 공격수)</option>
					</select> <input type="hidden" name="user_position2"> <img alt=""
						src="image/join1.png" width="5%">서브포지션2 <select
						name="user_position13">
							<option value=""></option>
							<option value="GK">GK(골키퍼)</option>
							<option value="RB">RB(오른쪽 수비수)</option>
							<option value="LB">LB(왼쪽 수비수)</option>
							...
							<option value="LWF">LWF(왼쪽 공격수)</option>
							<option value="RWF">RWF(오른쪽 공격수)</option>
					</select> <input type="hidden" name="user_position3"></td>
				</tr>
				<tr>
					...
					<td colspan="5" style="text-align: left"><select
						name="user_address1">
					...
					</select> <select name="user_address2">
							<option></option>
							<option value="강남구">강남구</option>
							<option value="강동구">강동구</option>
							<option value="강북구">강북구</option>
							...
							<option value="중구">중구</option>
							<option value="중랑구">중랑구</option>
					</select> <select name="user_address3">
							<option></option>
							<option value="강남구">강남구</option>
							<option value="강동구">강동구</option>
							<option value="강북구">강북구</option>
				...
				<tr>
					...
					<td style="text-align: left" colspan="5"><input
						id="cmn-toggle-1" class="cmn-toggle cmn-toggle-round"
						name="user_helper" type="checkbox"> <label
						for="cmn-toggle-1"></label></td>
				</tr>
				<tr>
					<th>정보 공개 유무</th>
					<td style="text-align: left" colspan="5"><input
						id="cmn-toggle-2" class="cmn-toggle cmn-toggle-round"
						name="user_enabled" type="checkbox"> <label
						for="cmn-toggle-2"></label></td>
				</tr>
