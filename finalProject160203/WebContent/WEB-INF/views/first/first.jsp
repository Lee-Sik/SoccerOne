...
.bgwrap {position: absolute; left: 0px; top: 132px; width: 100%; height: 100%;}
...
function findOpen(){
	var popUrl = "search.do";	//팝업창에 출력될 페이지 URL
	var popOption = "width=500, height=600,top=70, left=220, resizable=no, scrollbars=no, status=no;";    //팝업창 옵션(optoin)
		window.open(popUrl,"",popOption);
	}	
</script>
</head>
...
<div class="intro-wrap">
	<div class="bgwrap">
		<video autoplay loop poster="<%=request.getContextPath()%>/image/maintitle.png" id="bgvid">
               <source src="<%=request.getContextPath()%>/video/mainopening.mp4" type="video/mp4">
           </video>
...
<input type="button" value="ID/PW 찾기" onclick="location.href='javascript:findOpen()'">
</td>
</tr>
</table>
</form>
