...
<tr>
	<th>클럽명</th><td style="text-align: left">${pmd.team_name}</td>
</tr>

<tr>
	<th>지역구</th><td style="text-align: left">${pmd.game_location}</td>
</tr>

<tr>
	<th>경기일자</th><td style="text-align: left">${pmd.game_date}</td>
</tr>
...
<tr>
	...
	<fmt:formatNumber value="${pmd.pay}" pattern="#,###.##' 원'"/></td>
</tr>
...
<td colspan="2">
<c:if test="${login.user_email != pmd.team_managerid && team.team_managerid eq login.user_email}"> 
