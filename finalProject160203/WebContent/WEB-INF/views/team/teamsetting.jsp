...
<body>
	...
	<div style="width: 100%">
		<form action="teamsetting1.do" method="post" name="f"
			...
			<table width="100%" class="bbslistta">
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="team_name"
						value="${team.team_name}" size="100"></td>
				</tr>
				<tr>
				<th>팀 관리자</th>
				<td>
				...
				<tr>
					<th>팀정보</th>
					<td><textarea name="team_intro" cols="100" rows="10">${team.team_intro}</textarea>
					</td>
				</tr>
				<tr>
					<th>팀인원</th>
				...
				<tr>
					...
					<td style="text-align: center"><select name="team_location1">
				...
				<tr>
					...
					<c:if test="${not empty team.team_home}">
						<td><input type="text" name="team_home"
					...
					<c:if test="${empty team.team_home}">
						<td><input type="text" name="team_home" value="no home"
							id="addr1" size="70"><a href="#"
							onclick="javascript:window.open('./post.do','','location=0,status=0,scrollbars=1,width=530,height=330');">
								<img src="image/wofun.png">
						</a> </td>
					</c:if>
