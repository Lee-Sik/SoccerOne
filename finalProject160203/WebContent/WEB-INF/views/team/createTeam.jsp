...
<form action="createTeamAf.do" method="post"
	...
	<table class="list_table" style="width: 85%;">
		...
		<tr>
			<th>팀 소개</th>
			<td style="text-align: left"><textarea name="team_intro"
		...
		<tr>
			<td style="text-align: left"><select name="team_location3">
					<c:forEach items="${list}" var="vo">
						<option>${vo}</option>
					</c:forEach>
			</select></td>
		...
		<tr>
			<th>팀 모집 유무</th>
			<td style="text-align: left"><input id="cmn-toggle-1"
				class="cmn-toggle cmn-toggle-round" name="team_j" type="checkbox">
				<label for="cmn-toggle-1"></label></td>
		</tr>
		<tr>
			<th>팀 정보 공개 유무</th>
			<td style="text-align: left"><input id="cmn-toggle-2"
				class="cmn-toggle cmn-toggle-round" name="team_o" type="checkbox">
		...
		<tr>
			...
			</a> <br> <input type="text" name="team_h" id="addr1" size="70">
			</td>
