...
<tr>
	<th>제목</th><td style="text-align: left"><input type="text" name="title" size="60" value='${gal.title}'/></td>
</tr>

<tr>
	<th>내용</th>
	<td style="text-align: left"><textarea rows="10" cols="50" name='content' id="_content">${gal.content}</textarea></td>
</tr>
...
$("#_btnupdate").click(function() {	
	alert('수정하기');	
	$("#_frmForm").attr({ "target":"_self", "action":"galupdateAf.do" }).submit();  // http://www.w3schools.com/jsref/prop_form_target.asp
});
</script>
