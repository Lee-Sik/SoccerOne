...
<body>
<form name="update" id="_updateAf" method="post" action="">
...
<tr>
	...
	<td><button type="button" id="_editBtn">수정하기</button></td>
</tr>
...
$("#_editBtn").click(function() {	
 	$("#_updateAf").attr({ "target":"_self", "action":"commentupdateAf.do" }).submit();
	alert("수정 완료!");
	window.close();
