...
<div id='menu'>
	...
	<ul class="menulist">
		<li><a href="./bbslist.do"><img src="./image/menu/soccerforum_off.png" class="image_rollover" /></a></li>
		<li><a href="./gallerylist.do"><img src="./image/menu/soccergallery_off.png" class="image_rollover" /></a></li>
		<li><a href="./sellbuylist.do"><img src="./image/menu/soccersellbuy_off.png" class="image_rollover" /></a></li>
	</ul>
