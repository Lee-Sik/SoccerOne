...
<style type="text/css">
#menu{background:#DD736A;}
.menulist {padding-top:70px; height:81px; margin-left: 450px;}
...
<div id='menu'>
	...
	<ul class="menulist">
		<li><a href="./adminmain.do"><img src="./image/menu/admin_off.png" class="image_rollover" /></a></li>
	</ul>
